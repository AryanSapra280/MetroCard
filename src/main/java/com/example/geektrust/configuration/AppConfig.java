...
import com.example.geektrust.repositories.implementations.PaymentTypeRepository;
...
public class AppConfig {
    ...
    private final IPaymentTypeRepository paymentMethodRepository = new PaymentTypeRepository();
    ...
    //Dependent declared
    private final IPaymentType metroCard = new MetroCardImpl(paymentMethodRepository);
